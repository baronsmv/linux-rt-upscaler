// CuNNy-4x16-NVL - Pass 1 - https://github.com/funnyplanter/CuNNy
...
[[vk::image_format("rgba8")]] RWTexture2D<float4> T2 : register(u2);
[[vk::image_format("rgba8")]] RWTexture2D<float4> T3 : register(u3);
