...
def _apply_style_overrides(cfg: GUIConfig, overrides: GUIStyleOverrides) -> GUIConfig:
    ...
    return replace(
        ...
        tile=replace(
            ...
            spacing_ratio=overrides.tile_spacing_ratio,
            pop_scale=overrides.tile_pop_scale,
            pop_duration=overrides.tile_pop_duration,
        ),
        sidebar=replace(
            cfg.sidebar,
            profiles_width=overrides.profiles_width,
            settings_width=overrides.settings_width,
            icon_columns=overrides.icon_columns,
        ),
