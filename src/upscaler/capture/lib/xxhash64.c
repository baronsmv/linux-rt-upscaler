...
void XXH64_update(XXH64_state_t *state, const void *input, size_t len) {
  ...
  if (state->memsize) {
    ...
    state->v1 =
        XXH64_rotl(state->v1 + m[0] * XXH_PRIME64_2, 31) * XXH_PRIME64_1;
    state->v2 =
        XXH64_rotl(state->v2 + m[1] * XXH_PRIME64_2, 31) * XXH_PRIME64_1;
    state->v3 =
        XXH64_rotl(state->v3 + m[2] * XXH_PRIME64_2, 31) * XXH_PRIME64_1;
    state->v4 =
        XXH64_rotl(state->v4 + m[3] * XXH_PRIME64_2, 31) * XXH_PRIME64_1;
    state->memsize = 0;
  }
