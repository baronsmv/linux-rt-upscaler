...
class UpscalerManager:
    ...
    manager handles both a single 2x upscale and a double-upscale (two
    chained 2x stages) for 4x output. Tile processing is available for
    2x upscaling when enabled in the configuration.
