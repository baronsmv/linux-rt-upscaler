...
The issue is possibly related to how Wine handles input events under X11/XWayland. Wine may be ignoring synthetic events that are not generated by the actual hardware, or it may be processing them differently because of its internal input stack. The exact low‑level behaviour is not yet understood.
